  ...
  return(
    <div className="flex flex-col  mt-72  md:p-11 p-6 px-8 ">
                  ...
                  <div className=" flex flex-row justify-between">
                        ...
                        <AnimateWhenInView duration={0.4} delay={0.2}>
              ...
              <section className=" mt-16 block sm:hidden">
                ...
                <div>
                {(state == "Designer")           ? 
                  <Scale initialScale={0} animateScale={1} exitScale={0} animateDelay={0.8} animateDuration={0.4} ><SlideVr initialOpacity={0} animateOpacity={1} exitOpacity={0} animateDelay={0.2} animateDuration={0.3} initialLocation={10} animateLocation={0} exitLocation={0}><SlideHr initialOpacity={0} animateOpacity={1} exitOpacity={0} animateDelay={0.2} animateDuration={0.} initialLocation={-140} animateLocation={0} exitLocation={0}>
                ...
                {(state == "Freelance Developer")           ? 
                  <Scale initialScale={0} animateScale={1} exitScale={0} animateDelay={0.8} animateDuration={0.4} ><SlideVr initialOpacity={0} animateOpacity={1} exitOpacity={0} animateDelay={0.2} animateDuration={0.3} initialLocation={10} animateLocation={0} exitLocation={0}>
                  <div className=" text-center"> <h1 className="font-medium">{state}</h1> </div>
                  </SlideVr></Scale>
                                        :
                  <p className="h-3"></p>
              ...
              <div className=" flex mt-16 flex-row justify-center">
                <div className="ml-36 flex flex-col justify-center items-center">
                  <AnimateWhenInView duration={0.4} delay={1}  Iopacity={0} Fopacity={1} Is={1} Fs={1} Ix={-10} Iy={0} Fy={0} Fx={0} >
                  ...
                  <AnimateWhenInView duration={0.4} delay={1}  Iopacity={0} Fopacity={1} Is={1} Fs={1} Ix={0} Iy={0} Fy={0} Fx={0} >
                      <h1 className="hover:shadow-lg hover:-translate-y-1 transition duration-100 font-semibold text-sm ">Designer</h1>
                  </AnimateWhenInView>
                </div>
                 <div className="ml-36 flex flex-col justify-center items-center">
                  <AnimateWhenInView duration={0.4} delay={1}  Iopacity={0} Fopacity={1} Is={1} Fs={1} Ix={-10} Iy={0} Fy={0} Fx={0} >
                  ...
                  <AnimateWhenInView duration={0.4} delay={1}  Iopacity={0} Fopacity={1} Is={1} Fs={1} Ix={0} Iy={0} Fy={0} Fx={0} >
                       <h1 className="hover:shadow-lg hover:-translate-y-1 transition duration-100 font-semibold text-sm ">Freelance Developer</h1>
                  </AnimateWhenInView>
                </div>
                <div className="ml-36 flex flex-col justify-center items-center">
                  <AnimateWhenInView duration={0.4} delay={1}  Iopacity={0} Fopacity={1} Is={1} Fs={1} Ix={-10} Iy={0} Fy={0} Fx={0} >
                  ...
                  <AnimateWhenInView duration={0.4} delay={1}  Iopacity={0} Fopacity={1} Is={1} Fs={1} Ix={0} Iy={0} Fy={0} Fx={0} >
                       <h1 className="hover:shadow-lg hover:-translate-y-1 transition duration-100 font-semibold text-sm ">Entrepreneur</h1>
                  </AnimateWhenInView>
                </div>
              </div>
              </section>
