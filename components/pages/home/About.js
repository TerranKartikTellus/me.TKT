...
export default function About(){
  return(
    <div className="flex flex-col mt-28 p-3 pt-5 md:p-11 ">
              <div className="flex flex-row justify-between">
                        <h1 className="tracking-wide font-semibold text-2xl sm:text-3xl md:text-4xl">About</h1>
                        <a href="/about"><img className="w-8 h-8" src="./svg/share_move_black.svg"></img></a>
              </div>
              <div className="flex flex-col md:flex-row mt-6 md:mt-10 text-justify text-sm">
                  <div><svg className="w-44 h-44" xmlns="http://www.w3.org/2000/svg" fill="black" width="30" height="30" viewBox="0 0 24 24"><path d="M20.822 18.096c-3.439-.794-6.64-1.49-5.09-4.418 4.72-8.912 1.251-13.678-3.732-13.678-5.082 0-8.464 4.949-3.732 13.678 1.597 2.945-1.725 3.641-5.09 4.418-3.073.71-3.188 2.236-3.178 4.904l.004 1h23.99l.004-.969c.012-2.688-.092-4.222-3.176-4.935z"/></svg></div>
                  <div className="ml-6 mt-6 flex flex-col items-baseline">
                    
                    <div><span className="font-medium tracking-wide text-xl">Hi, I’m Terran. Nice to meet you.</span></div><br/>
