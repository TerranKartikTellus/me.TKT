...
export  default function YoutubeCards({YTdata}){
      ...
      {
          items.map(item=>(
            <div key={item.id} className="hover:scale-105 transition duration-200 ease-in-out w-72 md:mx-2 my-4 mx-auto  bg-opacity-40 bg-gradient-to-tr ring-2 ring-gray-100  rounded-xl flex flex-col ">
                  ...
                  <div className="w-72 rounded-b-xl  bg-slate-100 shadow-lg ">
                        <div className="px-4"><p className="font-semibold text-lg  ">{item.snippet.title}</p> </div>
                        ...
                        <div className="mt-20 flex flex-row justify-center rounded-b-xl items-center hover:bg-slate-100 text-slate-100 hover:text-slate-900 transition duration-200 ease-in-out bg-slate-900">
